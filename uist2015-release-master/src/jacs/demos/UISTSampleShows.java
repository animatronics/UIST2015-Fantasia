...
public class UISTSampleShows extends JFrame implements ActionListener {
	 ...
	 */
	public static final int SERVO_SWEEP = 0; // 1 audio, 3 motors not synched to audio(音声に同調しない１つの音声と３つのモーター)
	public static final int MOUTH_SYNCH = 1; // 1 mouth synched to audio（音声と同調した１つの口）
	public static final int ONE_CHARACTER = 2; // 1 mouth synched to audio and 2 motors for head and neck（音声と同調した１つの口と頭と首のための２つのモーター）
	public static final int FROG_ACTION = 3; // placeholder to show where to add your own show files（自分たちでファイルを加える）
	...
	/* 3 */"data/MouthSynchTestOneMinute.csv" };
	...
	/* 3 */"Attach servo to pins 2 for frog_action and observe how motion corresponds to audio." };
